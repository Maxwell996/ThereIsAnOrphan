...
class Child(models.Model):
    ...
    edu = models.CharField(verbose_name='教育水平',max_length=20)
    enter_time = models.DateField(verbose_name='入院时间',default=datetime.today(),blank=False,null=False)
    weight = models.DecimalField(verbose_name='体重/kg',max_digits=2,decimal_places=2,default=0)
    temperature = models.DecimalField(verbose_name='体温',max_digits=2,decimal_places=2,default=0)
    right_sight = models.DecimalField(verbose_name='右眼视力',max_digits=5,decimal_places=2,default=0)
    left_sight = models.DecimalField(verbose_name='左眼视力',max_digits=2,decimal_places=2,default=0)
...
class Employee(models.Model):
    ...
    ethnic_groups = models.CharField(verbose_name='民族',max_length=20)
...
class To_doList(models.Model):
    ...
    num = models.CharField(verbose_name='安排编号',max_length=18, blank=False, unique=True, null=False, primary_key=True)
    ...
    #发布者为管理员
    publisher = models.CharField(verbose_name='发布者',max_length=18,blank=False,null=False,default='管理员')
...
class Audit(models.Model):
    ...
    #可能是外人可能是员工
    publisher = models.CharField(verbose_name='申请者', max_length=18, blank=False, null=False,default="申请者")
...
class Step_parent(models.Model):
    ...
    age = models.IntegerField(verbose_name='年龄', default=0, blank=False, null=False)
    edu = models.CharField(verbose_name='学历', max_length=20)
    weight = models.DecimalField(verbose_name='月收入', max_digits=2, decimal_places=2, default=0)
